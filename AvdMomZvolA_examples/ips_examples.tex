...
These constructions highlight the potential of sequential extensions and limitations in merging sets,
...
\parbox{1\linewidth}{\caption{PIPS of cardinality 42 and diameter 2473117504}
\label{42_symm.eps}}
\end{figure}

\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{./img/46_symm.eps}}
\parbox{1\linewidth}{\caption{PIPS of cardinality 46 and diameter 3118278592}
\label{46_symm.eps}}
\end{figure}

\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{./img/48_symm.eps}}
\parbox{1\linewidth}{\caption{PIPS of cardinality 48 and diameter 71720407616}
\label{48_symm.eps}}
\end{figure}
...
\parbox{1\linewidth}{\caption{PIPS of cardinality 9 and diameter 2890}
...
\parbox{1\linewidth}{\caption{PIPS of cardinality 19 and diameter 20663808074}
...
\parbox{1\linewidth}{\caption{PIPS of cardinality 17 and diameter 1024296}
...
\begin{figure}[h!]
	...
	\parbox{1\linewidth}{\caption{PIPS of cardinality 10 and diameter 2431}
...
\begin{figure}[h!]
	...
	\parbox{1\linewidth}{\caption{PIPS of cardinality 15 and diameter 19203744}
...
\parbox{1\linewidth}{\caption{PIPS of cardinality 8 and diameter 2535}
\label{8_2535_1_d680}}
\end{figure}
...
\begin{figure}[h!]
	...
	\parbox{1\linewidth}{\caption{PIPS of cardinality 8 and diameter 2400}

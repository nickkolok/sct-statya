...
Характеристика инвариантна относительно сдвига, растяжения, отражения, а также добавления или удаления точек.
...
\Definition{ 3}(\cite{kemnitz1988punktmengen,kurz2005characteristic})
	The characteristic of a planar integral point set $\mathcal{P}$ is the least positive integer $p$
	such that the area of any triangle with vertices $P_1, P_2, P_3 \in \mathcal{P}$
	is commensurable with $\sqrt{p}$.
...
\Definition{ 4}
	A PIPS $\mathcal{P}$ is said to be in \emph{semi-general position}
	if no three points of $\mathcal{P}$ are located in a straight line.
...
\Definition{ 6}
	A planar integral point set $\mathcal{P}$ is said to be in \emph{general position}
	if no three points of $\mathcal{P}$ are located on a straight line
	and no four points of $\mathcal{P}$ are located on a circle.
...
The main purpose of this work is to demonstrate examples of planar integral point sets

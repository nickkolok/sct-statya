...
Например, правильный треугольник со стороной 1 показывает, что $F(3)=1$.
...
Однако координаты любого (не обязательно оптимального) множества с точностью до движения имеют вид
$$
	\left(
...
\item.
В большинстве обсчитанных случаев оптимальное расположение точек определяется однозначно с точностью до движения.

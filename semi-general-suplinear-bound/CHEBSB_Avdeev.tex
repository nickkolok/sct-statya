...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% {{ biblatex
%% Команда \Cite (с большой буквы) у biblatex своя.
%% Сохраняем "нашу"
\let\CiteChebSb=\Cite
%% Убираем \Cite
\let\Cite=\relax
%% Вот теперь смело загружаем biblatex
\usepackage[backend=biber,style=gost-numeric,sorting=none,dashed=false]{biblatex}
%\usepackage[backend=biber,style=bath,sorting=ynt]{biblatex}
\addbibresource{../common/notmy.bib}
\addbibresource{../common/my.bib}
%% Восстанавливаем "нашу" \Cite
\let\Cite=\CiteChebSb
%% }} biblatex

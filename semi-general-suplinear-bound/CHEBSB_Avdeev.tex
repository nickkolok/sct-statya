...
The existing lower bound for mininum diameter of a planar integral point set is linear with respect to its cardinality.
...
The proof is based on several lemmas and observations, including the ones provided by Solymosi

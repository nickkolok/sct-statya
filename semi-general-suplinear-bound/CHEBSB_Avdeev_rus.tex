...
\begin{remark}
	Лемма~\ref{lem:count_of_points_on_hyperbolas} основана на работе~\cite{erdos1945integral}.
\end{remark}
...
Автор благодарит проф. Е.М. Семёнова и к.ф.-м.н. А.С. Усачёва за обсуждение статьи и ценные советы.

...
\title{
	On classification of integral point sets and particular upper bounds for their minimal diameter in higher dimensions
	\footnote{
...
This paper is an extended version of preprint~\cite{avdeev2019particular}.

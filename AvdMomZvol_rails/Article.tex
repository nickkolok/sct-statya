...
First, we discuss the classification of planar integral points sets;
then, we present some bounds for $d(m,n)$ based on planar integral point sets of special types
...
For the sake of brevity, we use the notation \cite{our-ped-2018,our-pmm-2018,our-vmmsh-2018}:

...
In the present paper, the case of $m=2$ will mostly be in the focus.
...
Each Section consists of 2 Subsections: General results an Special results.
In General results, avoid attempts to provide tight estimates;
such attempts are done in Special results.
...
To obtain the needed estimate, we now prove a generalization of~\cite[Lemma 3]{our-vmmsh-2018-translit}.
...
Now we need to estimate $\varphi_n$ with $\beta/\sqrt{n-n_0}$.
Using the upper bound of Theorem~\ref{thm:varphi_k_bounds},
one can easily find the values of $\beta$ and $n_0$.

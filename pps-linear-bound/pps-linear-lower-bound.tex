...
Integral point sets with many collinear ponts are very dominating examples.
...
is carried out;
thus, we can restrict our attention to intersections of planar integral point sets with lne segments of length more than 10 000.
...
Concluding the section, we remark that

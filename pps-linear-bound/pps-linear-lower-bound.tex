...
Performing some trivial manipulations with the upper bound in Theorem~\ref{thm:varphi_k_bounds},
...
\begin{proof}
	...
	Lemma~\ref{lem:square_container} yields that $M$ is situated is a square with side length $b$.

...
\begin{construction}
	...
	\begin{equation}
		...
		.
	\end{equation}
	In particular, for $k>1$ and $H = \{k-1\}$ we obtain $C_H = 2^{2^{k-1}}+1$
	(for $k=1$, we consider $H=\varnothing$ and $c_H = 1$).
	Moreover
	\begin{equation}
		b_H =
...
\begin{remark}
	For $k=1$ in Construction~\ref{con:planar_set_with_minimeter_1},

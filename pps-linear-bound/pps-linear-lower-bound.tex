...
and estimates; in the present paper, the case of $m=2$ will mostly be in the focus.
...
Now we need to estimate the quanity of points in an intersection of an integral point set with a line segment.

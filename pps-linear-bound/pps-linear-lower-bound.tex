...
\end{conjecture}
Such an estimate is based on the number of edges in an $(m-2)$-dimensional simplex.
...
\begin{conjecture}
	...
	For every $n \geq 3$, $d \geq 1$ there exists a \textbf{prime}
...
N. N. Avdeev and E. M. Semenov, On point sets in the plane with integral distances (О множествах точек на плоскости с
целочисленными расстояниями), \emph{Matematicheskie zametki} 100.\textbf{5} (2016), 757–761.
%
...
G. Bat-Ochir, On the number of points with pairwise integral distances on a circle, \emph{Discrete Appl. Math.} 254 (2018),
17–32, \textsc{doi}: \href {https://doi.org/10.1016/j.dam.2018.07.004} {\nolinkurl {10.1016/j.dam.2018.07.004}}.
%
...
J. Garibaldi and A. Iosevich, The Erdős distance problem: lecture notes (2005).%
...
M. Locatelli and U. Raber, Packing equal circles in a square: a deterministic global optimization approach, \emph{Discrete Appl.
Math.} 122.\textbf{1-3} (2002), 139–166.
%
\bibitem{noll1989nclusters}
L. C. Noll and D. I. Bell, {$n$}-clusters for {$1<n<7$}, \emph{Math. Comp.} 53.\textbf{187} (1989), 439–444.
%
...
L. Piepmeyer, The maximum number of odd integral distances between points in the plane, \emph{Discrete Comput. Geom.}
16.\textbf{1} (1996), 113–115, \textsc{doi}: \href {https://doi.org/10.1007/bf02711135} {\nolinkurl {10.1007/bf02711135}}.
%

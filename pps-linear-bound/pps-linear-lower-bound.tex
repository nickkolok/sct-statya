...
\begin{proof}
	...
	yields to $b > 10000$, because we know the maximum number of points for planar integral point sets of diameters at most $10000$.
...
\end{conjecture}
Such as estimate is based on the number of edges in an $(m-2)$-dimensional simplex.
